...
const swipersInit = () => {
  ...
  ((Breakpoint2) => {
    ...
    Breakpoint2[Breakpoint2["SM"] = 576] = "SM";
    Breakpoint2[Breakpoint2["MD"] = 768] = "MD";
    Breakpoint2[Breakpoint2["LG"] = 1300] = "LG";
    Breakpoint2[Breakpoint2["XL"] = 1800] = "XL";
...
const headerControlsInit = () => {
  ...
  (_a = document.querySelector(".header__burger")) == null ? void 0 : _a.addEventListener("click", () => {
  ...
  (_b = document.querySelector(".header__search-btn")) == null ? void 0 : _b.addEventListener("click", () => {
    burger.classList.add("header__burger_opened");
